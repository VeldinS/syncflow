...
function Services() {
    return (
        <section className={'w-screen h-auto px-[5%] flex flex-col items-start justify-start gap-24'}>
            <div className={'w-full h-auto flex flex-col items-center lg:items-start justify-start gap-4'}>
                <h2 className={'text-4xl font-bold text-white tracking-wider'}>What We <span className={'text-mainGreen'}>Offer</span></h2>
            ...
            <div className={'w-full h-auto flex flex-col items-start justify-start gap-4 sm:gap-8'}>
